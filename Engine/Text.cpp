...
Text::Text(Window *window, float x, float y, float z, Camera *cam, std::string newText, Vector3 color) {

	Text(window, x, y, z, cam, newText);
	this->color = color;
}
...
void Text::changeColor(Vector3 newColor) {
...
void Text::reCenterize(int mode) {
